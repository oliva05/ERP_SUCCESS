...
{
    public partial class rptBoletaLibro : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public rptBoletaLibro(string pNum, string pCliente, decimal pvalor, DateTime pFecha)
        {
            InitializeComponent();
